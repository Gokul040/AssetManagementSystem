...
CdkTableExporterModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: CdkTableExporterModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
CdkTableExporterModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.3", ngImport: i0, type: CdkTableExporterModule, imports: [CdkTableModule] });
CdkTableExporterModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: CdkTableExporterModule, imports: [CdkTableModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: CdkTableExporterModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [],
                    imports: [
...
FileExporter.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: FileExporter, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
FileExporter.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: FileExporter, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: FileExporter, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
WorksheetExporter.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: WorksheetExporter, deps: [{ token: SheetjsHelperService }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: WorksheetExporter, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: SheetjsHelperService }]; } });
...
CsvExporterService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: CsvExporterService, deps: [{ token: SheetjsHelperService }], target: i0.ɵɵFactoryTarget.Injectable });
...
XlsExporterService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: XlsExporterService, deps: [{ token: SheetjsHelperService }], target: i0.ɵɵFactoryTarget.Injectable });
...
JsonExporterService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: JsonExporterService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
JsonExporterService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: JsonExporterService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: JsonExporterService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
XlsxExporterService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: XlsxExporterService, deps: [{ token: SheetjsHelperService }], target: i0.ɵɵFactoryTarget.Injectable });
XlsxExporterService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: XlsxExporterService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: XlsxExporterService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: CdkTableExporter, decorators: [{
            type: Directive
        }], ctorParameters: function () { return [{ type: ServiceLocatorService }, { type: DataExtractorService }, { type: undefined }]; }, propDecorators: { hiddenColumns: [{
                type: Input
            }], exporter: [{
                type: Input
            }], exportCompleted: [{
...
//# sourceMappingURL=cdk-table-exporter.mjs.map
